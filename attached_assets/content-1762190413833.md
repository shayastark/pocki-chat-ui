...
**Note:** For more fine-grained capability detection, use the [`getCapabilities()`](https://miniapps.farcaster.xyz/docs/sdk/detecting-capabilities#getcapabilities) method which returns specific SDK methods supported by the host.
